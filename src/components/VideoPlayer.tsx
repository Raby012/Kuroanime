...
if (malId) {
  ...
  // Listen for MegaPlay messages — detect errors and progress
  useEffect(() => {
    function handleMessage(event: MessageEvent) {
      try {
        ...
        if (
          ...
          setEmbedError(true);
          // Auto-advance past error after 1s
  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full aspect-video bg-black rounded-xl overflow-hidden relative">
        {isEmbed ? (
          <>
            ...
            />
            {/* Try next source button — always visible on embed */}
      ...
      <div className="mt-2 flex flex-col sm:flex-row sm:items-center gap-2">
        ...
        {/* Scrollable source buttons on mobile */}
